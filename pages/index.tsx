  ...
  social: [
    {
      name: "Facebook",
      href: "#",
      icon: function FacebookImage(props: SVGProps<SVGSVGElement>) {
        return (
    ...
    },
    {
      name: "Instagram",
      href: "#",
      icon: function InstagramImage(props: SVGProps<SVGSVGElement>) {
        return (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
    ...
    },
    {
      name: "Twitter",
      href: "#",
      icon: function TwitterImage(props: SVGProps<SVGSVGElement>) {
        return (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    },
    {
      name: "GitHub",
      href: "#",
      icon: function GitHubImage(props: SVGProps<SVGSVGElement>) {
        return (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
    ...
    },
    {
      name: "Dribbble",
      href: "#",
      icon: function DribbleImage(props: SVGProps<SVGSVGElement>) {
        return (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
