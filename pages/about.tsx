      ...
      <div className="relative px-4 pt-12 pb-16 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
        <div className="lg:col-start-2 lg:pl-8">
          <div className="mx-auto text-base max-w-prose lg:max-w-lg lg:ml-auto lg:mr-0">
            <h2 className="font-semibold tracking-wide text-indigo-600 uppercase leading-6">
              Work with us
            </h2>
            <h3 className="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 leading-8 sm:text-4xl">
              Our Process
            </h3>
            ...
            <div className="mt-5 text-gray-500 prose prose-indigo">
              <p>
